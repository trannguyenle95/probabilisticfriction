...
PlaneSegmentation::PlaneSegmentation() : BaseSegmentation() {
  ...
  update_params_srv =
      node.advertiseService("material_segmentation/update_params",
                            &PlaneSegmentation::update_parameters_cb, this);
}

bool PlaneSegmentation::update_parameters_cb(
    material_segmentation::PlaneSegmentationParams::Request &req,
    material_segmentation::PlaneSegmentationParams::Response &res) {
