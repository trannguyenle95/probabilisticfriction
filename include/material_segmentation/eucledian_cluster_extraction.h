...
#include <material_segmentation/EucledianClusterParams.h>
...
public:
  ...
  bool
  update_parameters_cb(material_segmentation::EucledianClusterParams::Request &,
                       material_segmentation::EucledianClusterParams::Response &);
