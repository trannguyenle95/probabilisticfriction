...
// ROS
#include <material_segmentation/BaseSegmentationParams.h>
#include <material_segmentation/ChangeSegmentationMethod.h>
#include <material_segmentation/SegmentScene.h>
...
public:
  ...
  bool segment_scene_service(material_segmentation::SegmentScene::Request &,
                             material_segmentation::SegmentScene::Response &);
  ...
  bool
  update_parameters_cb(material_segmentation::BaseSegmentationParams::Request &,
                       material_segmentation::BaseSegmentationParams::Response &);
