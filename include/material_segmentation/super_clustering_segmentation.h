...
#include <material_segmentation/SuperClusteringSegParams.h>
...
public:
  ...
  bool update_parameters_cb(
      material_segmentation::SuperClusteringSegParams::Request &,
      material_segmentation::SuperClusteringSegParams::Response &);
